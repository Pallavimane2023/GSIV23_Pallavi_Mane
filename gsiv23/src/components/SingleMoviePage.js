...
const SingleMoviePage = () => {
  ...
  return (
    <Container style={{display:"grid",gridTemplateColumns: "1fr 1fr",border:"1px solid grey",borderRadius:"10px"}}>
      ...
      <Card sx={{ maxWidth: 345 }}>
        ...
        <CardContent sx={{height:300}}>
          ...
          <Typography variant="body2" color="text.secondary">
            <b>Casts:</b><br/>{casts[0] + "," + casts[1] + "..."}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            <b>Discription:</b><br/>{movieInfo?.overview.substring(0, 500)}
          </Typography>
        </CardContent>
      </Card>
      </div>
